...
const ActionDropdown = ({ file }: ActionDropdownProps) => {
  ...
  const renderDialogContent = () => {
      ...
      return (
        <DialogFooter className="flex flex-col gap-[10px] md:flex-row mt-[10px]">
          <button
            ...
            className="btn btn-soft btn-error min-h-[40px] flex-1 rounded-[10px]"
          >
            Cancel
          </button>
          <button
    ...
    return (
      <DialogContent className="max-w-[600px] text-[14px]">
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
      <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
        <DropdownBtn />
        <DropdownMenuContent className="min-w-[200px] max-w-[250px] p-[10px] border-0 shadow-lg ">
